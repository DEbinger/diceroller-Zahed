...
export default class Zahed extends React.Component {
  ...
  handleButtonPress=()=> {
    ...
    let TotalS1 = D6S1 + 8;
    let TotalS2 = diceroll6S1a + 8;
    let TotalS3 = diceroll6S1b + 8;
  ...
  render() {
    ...
    const D20S3Style = this.state.NumberHolderD20S4 === 20 | this.state.NumberHolderD20S4 === 19 | this.state.NumberHolderD20S4 === 18 | this.state.NumberHolderD20S4 === 1 ? styles.bottomItemInner20picked : styles.bottomItemInner20;

    return (
      <ImageBackground source={require('../images/Zahed2.jpg')} style={styles.container}>
