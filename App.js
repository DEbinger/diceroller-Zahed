...
class Laylo extends React.Component {
  constructor(props) {
    super(props);
 ...
 imgClick = () => {
  ...
  render() {
    const { navigate } = this.props.navigation;
    const D20S1Style = this.state.NumberHolderD20S1 === 20 | this.state.NumberHolderD20S1 === 19 ? styles.bottomItemInner20picked : styles.bottomItemInner20;
    const D20S2Style = this.state.NumberHolderD20S2 === 20 | this.state.NumberHolderD20S2 === 19 ? styles.bottomItemInner20picked : styles.bottomItemInner20;
    const D20S3Style = this.state.NumberHolderD20S3 === 20 | this.state.NumberHolderD20S3 === 19 ? styles.bottomItemInner20picked : styles.bottomItemInner20;
...
class Laylo2 extends React.Component {
  constructor(props) {
    super(props);
